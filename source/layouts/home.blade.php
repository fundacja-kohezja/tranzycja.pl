    ...
    <section class="flex flex-col-reverse mb-10 lg:flex-row lg:mb-24">
        ...
        <div class="-mt-32 -mb-20 lg:-mt-10 lg:mb-0 xl:-mr-10 ml-5 flex-shrink-0">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" class="h-auto w-full max-w-xs ml-auto opacity-10 lg:opacity-50" viewBox="50 50 180 140">
                    ...
                    <rect x="120" y="80" class="logo-white" width="40" height="40"/>
    ...
    <section class="mb-24">
        <div>
            <h1 class="inline-block mr-4 text-indigo-600 dark:text-purple-300 mb-0 text-3xl sm:text-4xl uppercase tracking-wider">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="inline mr-2 h-9 sm:h-10 text-blue-400 align-middle -mt-8 -mb-8">
                    ...
                    <li class="slider-item-wider flex mx-2">
                        <a class="excerpt-card numbered flex flex-grow border-b-0 bg-gray-300 hover:bg-gray-350 dark:bg-gray-800 dark:hover:bg-blue-900 shadow rounded-lg break-words px-4 py-6" href="{{ $poradnik->getUrl() }}">
                            <article class="flex flex-grow flex-col">
                                <h2 class="font-bold leading-tight text-gray-700 text-2xl mb-0">
                                    {!! $poradnik->title() !!}
                                </h2>
    ...
    <section class="mb-24">
        <div>
            <h1 class="inline mr-4 text-indigo-600 dark:text-purple-300 text-3xl sm:text-4xl uppercase tracking-wider">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="inline mr-2 h-9 sm:h-10 text-blue-400 align-middle -mt-8 -mb-6">
    ...
    <section>
        <div>
            <h1 id="faq" class="inline mr-4 text-indigo-600 dark:text-purple-300 text-3xl sm:text-4xl uppercase tracking-wider">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="inline mr-2 h-8 sm:h-10 text-blue-400 align-middle -mt-8 -mb-6">
