...
<main class="container max-w-6xl mx-auto px-6 py-10 md:py-12">
    ...
    <section class="mb-24">
        <div>
            <h1 class="inline-block mr-4 text-pink-600 dark:text-purple-300 mb-0 text-4xl">
    ...
    <section class="mb-24">
        <div>
            <h1 class="inline mr-4 text-pink-600 dark:text-purple-300 text-4xl">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="inline mr-3 h-12 align-middle -mt-8 -mb-6">
    ...
    <section>
        <div>
            <h1 id="faq" class="inline mr-4 text-pink-600 dark:text-purple-300 text-4xl">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="inline mr-3 h-12 align-middle -mt-8 -mb-6">
