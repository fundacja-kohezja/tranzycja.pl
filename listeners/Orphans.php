...
class Orphans
{
    ...
    public function process(string $content): string
    {
        ...
        /* orphans */
        $re      = '/^([' . $this->single_letters . ']|' . preg_replace( '/\./', '\.', implode( '|', $this->terms ) ) . ') +/i';
